...
public interface RuntimeResourcePack extends ResourcePack {
  ...
  /**
   * Add a recipe <i>as well as</i> a corresponding advancement to obtain that recipe. <b>The {@link RecipeJsonFactory} must have an {@link ItemGroup}, or it will throw an exception.</b>
   *
