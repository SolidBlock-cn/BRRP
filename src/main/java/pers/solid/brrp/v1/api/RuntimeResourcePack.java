...
public interface RuntimeResourcePack extends ResourcePack {
   ...
   * @param lootTable  The loot table object. It can be created through {@link LootTable#builder()}. Please also refer to {@link LootTableProvider} for some methods to conveniently create loot tables.
   */
  @Contract(mutates = "this")
   ...
   *
   * @param identifier The identifier of the loot table. Please refer to {@link AbstractBlock#getLootTableId()}.
   * @param lootTable  The loot table (builder) object. It can be created through {@link LootTable#builder()}. Please also refer to {@link LootTableProvider} for some methods to conveniently create loot tables.
   */
  @Contract(mutates = "this")
   ...
   */
  @Contract(mutates = "this")
  <T> byte[] addTag(TagKey<T> tagKey, Tag.Builder tagBuilder);
