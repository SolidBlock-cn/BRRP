...
public abstract class ShapedRecipeJsonBuilderMixin implements ShapedRecipeJsonBuilderExtension {
  @Shadow
  public abstract ShapedRecipeJsonFactory criterion(String string, CriterionConditions arg);

  @Shadow
  public abstract ShapedRecipeJsonFactory pattern(String patternStr);
  ...
  private ShapedRecipeJsonFactory self() {
    return (ShapedRecipeJsonFactory) (Object) this;
  }

  @Override
  public ShapedRecipeJsonFactory patterns(String... patterns) {
  ...
  @Override
  public ShapedRecipeJsonFactory criterionMethodBridge(String criterionName, CriterionConditions criterionConditions) {
    return criterion(criterionName, criterionConditions);
  }

  @Override
  public ShapedRecipeJsonFactory setBypassesValidation(boolean bypassesValidation) {
  ...
  @Override
  public ShapedRecipeJsonFactory setCustomRecipeCategory(@Nullable String recipeCategory) {
