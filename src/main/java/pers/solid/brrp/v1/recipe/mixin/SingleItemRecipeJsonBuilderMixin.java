...
public abstract class SingleItemRecipeJsonBuilderMixin implements SingleItemRecipeJsonBuilderExtension {
  ...
  @Shadow
  public abstract SingleItemRecipeJsonFactory criterion(String string, CriterionConditions criterionConditions);

  private boolean bypassesValidation;
  private @Nullable String customRecipeCategory;

  @SuppressWarnings("DataFlowIssue")
  private SingleItemRecipeJsonFactory self() {
    return (SingleItemRecipeJsonFactory) (Object) this;
  }

  @Override
  public SingleItemRecipeJsonFactory criterionMethodBridge(String criterionName, CriterionConditions criterionConditions) {
    return criterion(criterionName, criterionConditions);
  }

  @Override
  public SingleItemRecipeJsonFactory setBypassesValidation(boolean bypassesValidation) {
  ...
  @Override
  public SingleItemRecipeJsonFactory setCustomRecipeCategory(@Nullable String recipeCategory) {
