...
public abstract class CookingRecipeJsonBuilderMixin implements CookingRecipeJsonBuilderExtension {
  ...
  @Shadow
  public abstract CookingRecipeJsonFactory criterion(String string, CriterionConditions criterionConditions);

  private boolean bypassesValidation;
  private @Nullable String customRecipeCategory;

  @SuppressWarnings("DataFlowIssue")
  private CookingRecipeJsonFactory self() {
    return (CookingRecipeJsonFactory) (Object) this;
  }

  @Override
  public CookingRecipeJsonFactory criterionMethodBridge(String criterionName, CriterionConditions criterionConditions) {
    return criterion(criterionName, criterionConditions);
  }

  @Override
  public CookingRecipeJsonFactory setBypassesValidation(boolean bypassesValidation) {
  ...
  @Override
  public CookingRecipeJsonFactory setCustomRecipeCategory(@Nullable String recipeCategory) {
