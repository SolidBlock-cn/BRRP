...
public class IdentifiedTagBuilder<T> extends ObjectTagBuilder<T, IdentifiedTagBuilder<T>> {
  ...
  /**
   * The path that the tag is stored in the tag file. It is similar to {@link RequiredTagList#dataType} and {@link net.minecraft.data.server.AbstractTagProvider#getOutput(Identifier)}. The example values of the field: {@code blocks}, {@code items}, {@code fluids}.
   */
