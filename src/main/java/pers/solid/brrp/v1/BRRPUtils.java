...
public final class BRRPUtils {
  ...
  public static Identifier getItemModelId(@NotNull ItemConvertible item) {
    return (item instanceof ItemResourceGenerator generator) ? generator.getItemModelId() : Registries.ITEM.getId(item.asItem()).brrp_prefixed("item/");
  }
  ...
  public static Identifier getBlockModelId(@NotNull Block block) {
    return (block instanceof BlockResourceGenerator generator) ? generator.getBlockModelId() : Registries.BLOCK.getId(block).brrp_prefixed("block/");
  }
