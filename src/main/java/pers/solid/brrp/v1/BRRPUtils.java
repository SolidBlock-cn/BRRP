...
public final class BRRPUtils {
   ...
   * @see ModelIds#getItemModelId(Item)
   */
  @Contract(pure = true)
  @PreferredEnvironment(EnvType.CLIENT)
  public static Identifier getItemModelId(@NotNull ItemConvertible item) {
    return (item instanceof ItemResourceGenerator) ? ((ItemResourceGenerator) item).getItemModelId() : ModelIds.getItemModelId(item.asItem());
  }
  ...
  public static Identifier getBlockModelId(@NotNull Block block) {
    return (block instanceof BlockResourceGenerator) ? ((BlockResourceGenerator) block).getBlockModelId() : ModelIds.getBlockModelId(block);
  }
