...
public class ModelElementBuilder implements Cloneable {
  ...
  public ModelElementBuilder from(float x, float y, float z) {
    return from(new Vec3f(x, y, z));
  }

  public ModelElementBuilder from(Vec3f from) {
    this.from = from;
    return this;
  }

  public ModelElementBuilder to(float x, float y, float z) {
    return to(new Vec3f(x, y, z));
  }

  public ModelElementBuilder to(Vec3f to) {
    this.to = to;
    return this;
  }
  ...
  public ModelElementBuilder rotation(Vec3f origin, Direction.Axis axis, float angle, boolean rescale) {
