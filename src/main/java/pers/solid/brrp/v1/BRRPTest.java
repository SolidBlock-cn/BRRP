...
public class BRRPTest {
  ...
  private static final Logger LOGGER = LogManager.getLogger(BRRPTest.class);
  ...
  private static void refreshPack(boolean clientIncluded, boolean serverIncluded) {
    ...
    if (serverIncluded) {
      ...
      PACK.addRecipeAndAdvancement(new Identifier("brrp", "smooth_stone_slab"), ShapedRecipeJsonFactory.create(Blocks.SMOOTH_STONE_SLAB, 6).pattern("###").input('#', SMOOTH_STONE).criterionFromItem(SMOOTH_STONE));
      PACK.addRecipeAndAdvancement(new Identifier("brrp", "smooth_stone_slab_from_stonecutting"), SingleItemRecipeJsonFactory.createStonecutting(Ingredient.ofItems(SMOOTH_STONE), Blocks.SMOOTH_STONE_SLAB).criterionFromItem(SMOOTH_STONE));

      PACK.addRecipeAndAdvancement(new Identifier("brrp", "cook_bedrock"), CookingRecipeJsonFactory.createSmelting(Ingredient.ofItems(Items.BEDROCK), Items.BARRIER, 1000, 2).setCustomRecipeCategory("brrp_custom").criterionFromItem(Items.BEDROCK));
      PACK.addRecipeAndAdvancement(new Identifier("brrp", "unobtainable_shaped"), ShapedRecipeJsonFactory.create(Items.BEDROCK).patterns("xx", "xx").input('x', Items.BEDROCK).setBypassesValidation(true).setCustomRecipeCategory("brrp_custom"));
      PACK.addRecipeAndAdvancement(new Identifier("brrp", "unobtainable_shapeless"), ShapelessRecipeJsonFactory.create(Items.BEDROCK).input(Items.STONE, 5).criterionFromItem(Items.STONE).setCustomRecipeCategory("brrp_custom").setBypassesValidation(true));
      PACK.addRecipeAndAdvancement(new Identifier("brrp", "unobtainable_single_item"), SingleItemRecipeJsonFactory.createStonecutting(Ingredient.ofItems(Items.STONE), Items.BEDROCK).setCustomRecipeCategory("brrp_custom").setBypassesValidation(true));
      PACK.addRecipeAndAdvancement(new Identifier("brrp", "smithing_transform"), SmithingRecipeJsonFactory.create(Ingredient.ofItems(Items.DIAMOND), Ingredient.ofItems(Items.STONE), Items.BEDROCK).setCustomRecipeCategory("brrp_custom").setBypassesValidation(true));
    }
  ...
  public static void registerPacks() {
    ...
    PACK.setDisplayName(new TranslatableText("brrp.pack.test.name"));
    PACK.setDescription(new TranslatableText("brrp.pack.test.description"));
    ...
    testEmptyPack.setDisplayName(new TranslatableText("brrp.pack.empty.name"));
    testEmptyPack.setDescription(new TranslatableText("brrp.pack.empty.description"));
    ...
    beforeUser.setDisplayName(new TranslatableText("brrp.pack.test_before_user.name"));
    beforeUser.setDescription(new TranslatableText("brrp.pack.test_before_user.description"));
