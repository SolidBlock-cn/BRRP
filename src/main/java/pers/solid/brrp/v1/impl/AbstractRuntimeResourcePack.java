...
public abstract class AbstractRuntimeResourcePack implements RuntimeResourcePack {
  ...
  public int packVersion = SharedConstants.getGameVersion().getPackVersion();
    ...
    if (resourceType == null) {
      ...
      switch (resourceType) {
        case CLIENT_RESOURCES:
          return clientResourceRegenerationCallback != null;
        case SERVER_DATA:
          return serverDataRegenerationCallback != null;
        default:
  ...
  public void setSidedRegenerationCallback(@NotNull ResourceType resourceType, FailableRunnable<InterruptedException> regenerationCallback) {
    switch (resourceType) {
      case SERVER_DATA:
        serverDataRegenerationCallback = regenerationCallback;
        break;
      case CLIENT_RESOURCES:
        clientResourceRegenerationCallback = regenerationCallback;
        break;
    }
  }
  ...
  public void regenerateSided(@NotNull ResourceType resourceType) throws InterruptedException {
    switch (resourceType) {
      case CLIENT_RESOURCES:
        clientResourceRegenerationCallback.run();
        break;
      case SERVER_DATA:
        serverDataRegenerationCallback.run();
        break;
    }
  }
