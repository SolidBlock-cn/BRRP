...
public class BRRPStairsBlock extends StairsBlock implements BlockResourceGenerator {
  ...
  public CraftingRecipeJsonFactory getCraftingRecipe() {
    return RecipesProvider.createStairsRecipe(this, Ingredient.ofItems(baseBlock)).criterion(RecipesProvider.hasItem(baseBlock), RecipesProvider.conditionsFromItem(baseBlock));
  }
}
