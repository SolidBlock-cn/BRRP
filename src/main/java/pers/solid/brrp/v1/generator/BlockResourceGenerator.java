...
public interface BlockResourceGenerator extends ItemResourceGenerator {
   ...
   * <p>You <i>must</i> override this method if you're implementing this interface on a non-{@code Block} class, or you intend to generate resources before registration.
   *
