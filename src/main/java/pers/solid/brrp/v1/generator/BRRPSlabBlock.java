...
public class BRRPSlabBlock extends SlabBlock implements BlockResourceGenerator {
  ...
  public @Nullable CraftingRecipeJsonFactory getCraftingRecipe() {
    return baseBlock == null ? null : RecipesProvider.createSlabRecipe(this, Ingredient.ofItems(baseBlock)).criterion(RecipesProvider.hasItem(baseBlock), RecipesProvider.conditionsFromItem(baseBlock));
  }
}
