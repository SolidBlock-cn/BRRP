...
public class BRRPFenceGateBlock extends FenceGateBlock implements BlockResourceGenerator {
  ...
  public CraftingRecipeJsonBuilder getCraftingRecipe() {
    ...
    return baseBlock == null || secondIngredient == null ? null : ShapedRecipeJsonBuilder.create(this).input('#', secondIngredient).input('W', baseBlock).pattern("#W#").pattern("#W#").criterion(RecipeProvider.hasItem(baseBlock), RecipeProvider.conditionsFromItem(baseBlock));
  }
