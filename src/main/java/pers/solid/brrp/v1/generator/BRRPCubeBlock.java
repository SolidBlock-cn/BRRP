...
public class BRRPCubeBlock extends Block implements BlockResourceGenerator {
   ...
   */
  public BRRPCubeBlock(Settings settings, Identifier parent, Texture textures) {
    super(settings);
    this.parent = parent;
  ...
  public static BRRPCubeBlock cubeAll(Settings settings, Identifier allTexture) {
    return new BRRPCubeBlock(settings, ModelUtils.getId(Models.CUBE_ALL), Texture.all(allTexture));
  }
  ...
  public static BRRPCubeBlock cubeBottomTop(Settings settings, Identifier topTexture, Identifier sideTexture, Identifier bottomTexture) {
    return new BRRPCubeBlock(settings, ModelUtils.getId(Models.CUBE_BOTTOM_TOP), new Texture().put(TextureKey.TOP, topTexture).put(TextureKey.SIDE, sideTexture).put(TextureKey.BOTTOM, bottomTexture));
  }
