...
public class RegenerateScreen extends Screen {
  ...
  protected void init() {
    super.init();
    stateText = new TextWidget(10, 25, width - 20, 20, STATE_IDLE, textRenderer).setTextColor(0xeeee66);
    summaryText = new TextWidget(10, 45, width - 20, 20, ScreenTexts.EMPTY, textRenderer).setTextColor(0xffcccccc);
