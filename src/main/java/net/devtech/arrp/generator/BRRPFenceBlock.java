...
public class BRRPFenceBlock extends FenceBlock implements BlockResourceGenerator {
  ...
  public @NotNull JBlockStates getBlockStates() {
    ...
    return JBlockStates.delegate(BlockStateModelGeneratorAccessor.createFenceBlockState(
        this,
  ...
  public @Nullable JRecipe getCraftingRecipe() {
    ...
    return baseBlock == null || secondIngredient == null ? null : new JShapedRecipe(this).resultCount(3).pattern("W#W", "W#W").addKey("W", baseBlock).addKey("#", secondIngredient);
  }
