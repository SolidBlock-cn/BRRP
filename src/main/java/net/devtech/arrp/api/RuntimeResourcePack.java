...
public interface RuntimeResourcePack extends ResourcePack {
   ...
   * <p>The parameter <i>advancementId</i> is typically prefixed with <code style="color:maroon">recipes/<i>recipeCategory</i></code> (for 1.19.3). In the convention of vanilla Minecraft, the identifier of the recipe is <code style="color:maroon"><i>namespace</i>:<i>path</i></code>, which is typically the same as the item itself. But the identifier of the advancement is <code style="color:maroon"><i>namespace</i>:recipes/<i>recipeCategory</i>/<i>path</i></code>.
  ...
  /**
   * <p>This method will add the recipe <i>as well as</i> the advancement of the recipe to the runtime resource pack. Usually, the identifier of the advancement is the recipe identifier prefixed with <code>recipes/<i>recipeCategory</i></code>, for example, the identifier of the <i>recipe</i> or oak_planks is <code style=color:maroon>minecraft:oak_planks</code> and the identifier of the <i>advancement</i> of the oak_planks recipes is <code style=color:maroon>minecraft:recipes/building_blocks/oak_planks</code>. This method just follows the convention of vanilla Minecraft's recipe and advancement, and you should <i>manually</i> specify the recipe category with {@link JRecipe#recipeCategory}.
   ...
   * @param categoryName                The name of the recipe category. This is used to specify in the identifier of the advancement. The identifier of the advancement will be the {@code recipeId} prefixed with <code>recipes/<i>recipeCategory</i>/</code>. The category name can be null.
  ...
  @ApiStatus.AvailableSince("0.7.0")
  @Contract(mutates = "this")
  default void addRecipeAndAdvancement(Identifier recipeId, @Nullable String categoryName, JRecipe recipeContainingAdvancement) {
