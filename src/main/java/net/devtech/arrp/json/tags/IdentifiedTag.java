...
public class IdentifiedTag extends JTag {
  ...
  /**
   * Create a new {@link IdentifiedTag} object with a vanilla-type {@link TagKey} object. The full identifier will be decided by {@link TagManagerLoader#getPath(RegistryKey)}.
   *
   * @param tagKey The vanilla {@code TagKey} object.
   */
  public IdentifiedTag(TagKey<?> tagKey) {
    this(StringUtils.removeStart(TagManagerLoader.getPath(tagKey.registry()), "tags/"), tagKey.id());
  }
